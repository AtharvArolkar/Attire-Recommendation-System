...
public class HistoryImageAdapter extends RecyclerView.Adapter<HistoryImageAdapter.ViewHolder> {
    ...
    ImageView imageView;
    TextView textView;
    public HistoryImageAdapter(View v){

    }

    public HistoryImageAdapter(ArrayList<ImageModel> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_history_image_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HistoryImageAdapter.ViewHolder holder, int position) {
