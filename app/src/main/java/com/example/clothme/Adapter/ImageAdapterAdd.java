...
public class ImageAdapterAdd extends  RecyclerView.Adapter<ImageAdapterAdd.ViewHolder>{
    ArrayList<ImageModel> list;
    Context context;
    ImageView imageView;
    TextView textView;
    public ImageAdapterAdd(View v){

    }

    public ImageAdapterAdd(ArrayList<ImageModel> list, Context context) {
        this.list = list;
